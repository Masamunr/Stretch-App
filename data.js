/* ---------------------------------------------------------
   ...
   photos/stock art, so no copyright concerns): a chunky
   stick figure, an accent-colored zone over the muscle being
   stretched, and a small arrow suggesting the movement.
--------------------------------------------------------- */
...
function svg(body, zone = '', arrow = '') {
  return `<svg viewBox="0 0 100 100" class="pose-svg" aria-hidden="true">${zone}${body}${arrow}</svg>`;
}
const GROUND = '<line x1="10" y1="92" x2="90" y2="92" class="ground"/>';
...
const STRETCHES = [
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="47" y2="60"/><line x1="47" y1="60" x2="35" y2="92"/><line x1="47" y1="60" x2="59" y2="92"/><line x1="49" y1="38" x2="30" y2="30"/><line x1="47" y1="40" x2="66" y2="55"/>`,
      `<ellipse class="zone" cx="63" cy="46" rx="10" ry="15"/>`,
  ...
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="26" r="9"/><line x1="50" y1="35" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="42" x2="30" y2="55"/><line x1="50" y1="42" x2="70" y2="55"/>`,
      `<ellipse class="zone" cx="50" cy="45" rx="16" ry="13"/>`,
      `<path class="arrow" d="M35 50 Q50 35 65 50" fill="none"/><polyline class="arrow" points="60,44 65,50 60,56"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><path d="M50 38 Q32 30 30 45" fill="none"/><path d="M50 38 Q68 30 70 45" fill="none"/>`,
      `<ellipse class="zone" cx="50" cy="36" rx="22" ry="10"/>`,
      `<path class="arrow" d="M30 40 Q50 20 70 40" fill="none"/><polyline class="arrow" points="64,34 70,40 64,46"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="40" x2="75" y2="45"/><line x1="50" y1="40" x2="20" y2="42"/><line x1="20" y1="42" x2="30" y2="30"/>`,
      `<ellipse class="zone" cx="72" cy="42" rx="12" ry="9"/>`,
  ...
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="38" x2="60" y2="15"/><line x1="60" y1="15" x2="55" y2="45"/><line x1="50" y1="45" x2="35" y2="50"/>`,
      `<ellipse class="zone" cx="57" cy="30" rx="8" ry="14"/>`,
      `<polyline class="arrow" points="46,40 52,48 58,40"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="30" cy="30" r="9"/><line x1="30" y1="39" x2="32" y2="60"/><line x1="32" y1="60" x2="24" y2="92"/><line x1="32" y1="60" x2="42" y2="92"/><line x1="30" y1="45" x2="75" y2="48"/><line x1="60" y1="40" x2="72" y2="50"/>`,
      `<ellipse class="zone" cx="52" cy="46" rx="20" ry="7"/>`,
      `<polyline class="arrow" points="68,42 75,48 68,54"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><path d="M50 40 Q28 45 32 65" fill="none"/><path d="M50 40 Q72 45 68 65" fill="none"/><line x1="32" y1="65" x2="68" y2="65"/>`,
      `<ellipse class="zone" cx="50" cy="48" rx="16" ry="10"/>`,
      `<polyline class="arrow" points="38,60 30,65 38,70"/><polyline class="arrow" points="62,60 70,65 62,70"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="58" cy="22" r="9"/><path d="M55 31 Q40 55 45 90" fill="none"/><line x1="45" y1="90" x2="35" y2="92"/><line x1="45" y1="90" x2="58" y2="92"/><line x1="55" y1="35" x2="20" y2="30"/><path d="M55 35 Q75 45 78 20" fill="none"/>`,
      `<ellipse class="zone" cx="66" cy="50" rx="10" ry="22"/>`,
      `<polyline class="arrow" points="48,54 42,60 50,66"/>`
    ),
  },
  {
    ...
    img: svg(
      `<circle cx="55" cy="30" r="9"/><line x1="55" y1="39" x2="52" y2="65"/><line x1="52" y1="65" x2="20" y2="72"/><line x1="52" y1="65" x2="35" y2="88"/><line x1="35" y1="88" x2="60" y2="80"/><line x1="55" y1="45" x2="72" y2="60"/><line x1="55" y1="42" x2="35" y2="35"/>`,
      `<ellipse class="zone" cx="45" cy="55" rx="14" ry="12"/>`,
      `<path class="arrow" d="M30 50 Q45 40 60 55" fill="none"/><polyline class="arrow" points="54,50 60,55 54,60"/>`
    ),
  },
  {
    ...
    img: svg(
      `<circle cx="78" cy="40" r="8"/><path d="M70 45 Q45 30 22 45" fill="none"/><line x1="22" y1="45" x2="20" y2="70"/><line x1="70" y1="45" x2="72" y2="70"/><line x1="30" y1="55" x2="28" y2="80"/><line x1="60" y1="55" x2="62" y2="80"/>`,
      `<ellipse class="zone" cx="45" cy="42" rx="22" ry="9"/>`,
      `<polyline class="arrow" points="40,40 45,32 50,40"/><polyline class="arrow" points="40,52 45,60 50,52"/>`
    ),
  },
  {
    ...
    img: svg(
      `<circle cx="80" cy="70" r="8"/><path d="M74 68 Q45 62 18 30" fill="none"/><line x1="18" y1="30" x2="14" y2="35"/><line x1="70" y1="72" x2="55" y2="88"/><line x1="55" y1="88" x2="75" y2="90"/>`,
      `<ellipse class="zone" cx="48" cy="55" rx="20" ry="11"/>`,
      `<polyline class="arrow" points="22,36 16,32 22,26"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="72" cy="55" r="8"/><path d="M65 58 Q45 60 20 88" fill="none"/><line x1="55" y1="70" x2="60" y2="90"/><line x1="65" y1="65" x2="68" y2="90"/>`,
      `<ellipse class="zone" cx="48" cy="76" rx="17" ry="8"/>`,
  ...
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="45" r="8"/><path d="M50 53 Q46 65 50 78" fill="none"/><line x1="50" y1="78" x2="42" y2="92"/><line x1="50" y1="78" x2="58" y2="92"/><line x1="46" y1="58" x2="38" y2="80"/>`,
      `<ellipse class="zone" cx="42" cy="78" rx="8" ry="16"/>`,
      `<polyline class="arrow" points="44,74 50,80 56,74"/>`
    ),
  },
  {
    ...
    img: svg(
      `<circle cx="72" cy="45" r="8"/><path d="M66 48 Q45 55 25 60" fill="none"/><line x1="25" y1="60" x2="24" y2="88"/><line x1="60" y1="55" x2="50" y2="72"/><line x1="66" y1="55" x2="60" y2="85"/><line x1="60" y1="85" x2="72" y2="85"/>`,
      `<ellipse class="zone" cx="42" cy="68" rx="22" ry="8"/>`,
      `<polyline class="arrow" points="34,58 26,62 34,68"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><path d="M50 60 Q58 75 50 82" fill="none"/><line x1="50" y1="82" x2="55" y2="60"/><line x1="50" y1="40" x2="60" y2="72"/>`,
      `<ellipse class="zone" cx="55" cy="66" rx="9" ry="14"/>`,
      `<polyline class="arrow" points="50,74 57,80 62,74"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="35" cy="45" r="8"/><line x1="35" y1="53" x2="40" y2="72"/><line x1="40" y1="72" x2="60" y2="70"/><line x1="60" y1="70" x2="65" y2="92"/><line x1="40" y1="72" x2="30" y2="90"/><line x1="30" y1="90" x2="45" y2="90"/>`,
      `<ellipse class="zone" cx="42" cy="62" rx="12" ry="10"/>`,
      `<polyline class="arrow" points="60,74 68,80 60,86"/>`
    ),
  },
  {
    ...
    img: svg(
      `<line x1="10" y1="80" x2="90" y2="80" class="ground"/><circle cx="18" cy="70" r="8"/><line x1="26" y1="70" x2="55" y2="72"/><line x1="55" y1="72" x2="55" y2="45"/><line x1="55" y1="60" x2="75" y2="55"/>`,
      `<ellipse class="zone" cx="60" cy="52" rx="14" ry="10"/>`,
      `<polyline class="arrow" points="70,44 78,50 70,56"/>`
    ),
  },
  {
    ...
    img: svg(
      `<line x1="10" y1="90" x2="90" y2="90" class="ground"/><circle cx="30" cy="55" r="8"/><path d="M35 58 Q50 62 60 60" fill="none"/><line x1="60" y1="60" x2="82" y2="80"/><line x1="35" y1="65" x2="25" y2="85"/><line x1="25" y1="85" x2="45" y2="85"/>`,
      `<ellipse class="zone" cx="42" cy="68" rx="14" ry="9"/>`,
      `<polyline class="arrow" points="48,70 55,75 58,70"/>`
    ),
  },
  {
    ...
    img: svg(
      `<circle cx="50" cy="35" r="9"/><line x1="50" y1="44" x2="50" y2="65"/><path d="M50 65 Q30 68 30 82" fill="none"/><path d="M50 65 Q70 68 70 82" fill="none"/><line x1="30" y1="82" x2="70" y2="82"/>`,
      `<ellipse class="zone" cx="50" cy="76" rx="24" ry="8"/>`,
      `<polyline class="arrow" points="35,72 30,78 40,78"/><polyline class="arrow" points="65,72 70,78 60,78"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="42" cy="24" r="8"/><line x1="42" y1="32" x2="42" y2="60"/><line x1="42" y1="60" x2="65" y2="92"/><line x1="42" y1="60" x2="30" y2="92"/><line x1="42" y1="36" x2="70" y2="30"/>`,
      `<ellipse class="zone" cx="38" cy="76" rx="9" ry="14"/>`,
      `<polyline class="arrow" points="24,82 30,88 36,82"/>`
    ),
  },
  {
    ...
    img: svg(
      `${GROUND}<circle cx="70" cy="50" r="8"/><path d="M64 55 Q45 40 30 70" fill="none"/><line x1="64" y1="55" x2="82" y2="88"/><line x1="30" y1="70" x2="18" y2="88"/>`,
      `<ellipse class="zone" cx="26" cy="78" rx="10" ry="12"/>`,
      `<polyline class="arrow" points="40,52 45,45 50,52"/>`
    ),
  },
  {
    ...
    img: svg(
      `<line x1="10" y1="80" x2="90" y2="80" class="ground"/><circle cx="18" cy="70" r="8"/><line x1="26" y1="70" x2="50" y2="72"/><line x1="50" y1="72" x2="45" y2="45"/><line x1="26" y1="66" x2="45" y2="48"/><line x1="50" y1="72" x2="78" y2="78"/>`,
      `<ellipse class="zone" cx="55" cy="66" rx="14" ry="10"/>`,
      `<polyline class="arrow" points="52,56 58,50 62,56"/>`
    ),
  },
];
