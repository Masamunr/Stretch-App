/* ---------------------------------------------------------
   Stretch data
   Each stretch pose is illustrated with a small hand-drawn
   stick-figure SVG (viewBox 0 0 100 100) so the whole app
   stays dependency-free -- no external images to fetch.
--------------------------------------------------------- */
...
const STRETCHES = [
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="47" y2="60"/><line x1="47" y1="60" x2="35" y2="92"/><line x1="47" y1="60" x2="59" y2="92"/><line x1="49" y1="38" x2="30" y2="30"/><line x1="47" y1="40" x2="66" y2="55"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="26" r="9"/><line x1="50" y1="35" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="42" x2="30" y2="55"/><line x1="50" y1="42" x2="70" y2="55"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><path d="M50 38 Q32 30 30 45" fill="none"/><path d="M50 38 Q68 30 70 45" fill="none"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="40" x2="75" y2="45"/><line x1="50" y1="40" x2="20" y2="42"/><line x1="20" y1="42" x2="30" y2="30"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><line x1="50" y1="38" x2="60" y2="15"/><line x1="60" y1="15" x2="55" y2="45"/><line x1="50" y1="45" x2="35" y2="50"/>`),
  },
  {
    id: 'wrist-flexor', name: 'Wrist Flexor Stretch', part: 'Wrists',
    ...
    img: svg(`${GROUND}<circle cx="30" cy="30" r="9"/><line x1="30" y1="39" x2="32" y2="60"/><line x1="32" y1="60" x2="24" y2="92"/><line x1="32" y1="60" x2="42" y2="92"/><line x1="30" y1="45" x2="75" y2="48"/><line x1="60" y1="40" x2="72" y2="50"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><line x1="50" y1="60" x2="62" y2="92"/><path d="M50 40 Q28 45 32 65" fill="none"/><path d="M50 40 Q72 45 68 65" fill="none"/><line x1="32" y1="65" x2="68" y2="65"/>`),
  },
  {
    id: 'standing-side-bend', name: 'Standing Side Bend', part: 'Spine',
    contexts: ['morning', 'postworkout'], difficulty: 'beginner',
    duration: 20, sides: true,
    ...
    img: svg(`${GROUND}<circle cx="58" cy="22" r="9"/><path d="M55 31 Q40 55 45 90" fill="none"/><line x1="45" y1="90" x2="35" y2="92"/><line x1="45" y1="90" x2="58" y2="92"/><line x1="55" y1="35" x2="20" y2="30"/><path d="M55 35 Q75 45 78 20" fill="none"/>`),
  },
  {
    id: 'seated-twist', name: 'Seated Spinal Twist', part: 'Spine',
    ...
    img: svg(`<circle cx="55" cy="30" r="9"/><line x1="55" y1="39" x2="52" y2="65"/><line x1="52" y1="65" x2="20" y2="72"/><line x1="52" y1="65" x2="35" y2="88"/><line x1="35" y1="88" x2="60" y2="80"/><line x1="55" y1="45" x2="72" y2="60"/><line x1="55" y1="42" x2="35" y2="35"/>`),
  },
  {
    id: 'cat-cow', name: 'Cat-Cow Flow', part: 'Spine',
    contexts: ['morning', 'postworkout'], difficulty: 'beginner',
    duration: 30,
    ...
    img: svg(`<circle cx="78" cy="40" r="8"/><path d="M70 45 Q45 30 22 45" fill="none"/><line x1="22" y1="45" x2="20" y2="70"/><line x1="70" y1="45" x2="72" y2="70"/><line x1="30" y1="55" x2="28" y2="80"/><line x1="60" y1="55" x2="62" y2="80"/>`),
  },
  {
    id: 'childs-pose', name: "Child's Pose", part: 'Back / Hips',
    ...
    img: svg(`<circle cx="80" cy="70" r="8"/><path d="M74 68 Q45 62 18 30" fill="none"/><line x1="18" y1="30" x2="14" y2="35"/><line x1="70" y1="72" x2="55" y2="88"/><line x1="55" y1="88" x2="75" y2="90"/>`),
  },
  {
    id: 'cobra', name: 'Cobra / Sphinx Stretch', part: 'Lower Back / Core',
    contexts: ['morning', 'postworkout'], difficulty: 'beginner',
    duration: 30,
    ...
    img: svg(`${GROUND}<circle cx="72" cy="55" r="8"/><path d="M65 58 Q45 60 20 88" fill="none"/><line x1="55" y1="70" x2="60" y2="90"/><line x1="65" y1="65" x2="68" y2="90"/>`),
  },
  {
    id: 'standing-forward-fold', name: 'Standing Forward Fold', part: 'Hamstrings / Back',
    ...
    img: svg(`${GROUND}<circle cx="50" cy="45" r="8"/><path d="M50 53 Q46 65 50 78" fill="none"/><line x1="50" y1="78" x2="42" y2="92"/><line x1="50" y1="78" x2="58" y2="92"/><line x1="46" y1="58" x2="38" y2="80"/>`),
  },
  {
    ...
    img: svg(`<circle cx="72" cy="45" r="8"/><path d="M66 48 Q45 55 25 60" fill="none"/><line x1="25" y1="60" x2="24" y2="88"/><line x1="60" y1="55" x2="50" y2="72"/><line x1="66" y1="55" x2="60" y2="85"/><line x1="60" y1="85" x2="72" y2="85"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="50" cy="24" r="9"/><line x1="50" y1="33" x2="50" y2="60"/><line x1="50" y1="60" x2="38" y2="92"/><path d="M50 60 Q58 75 50 82" fill="none"/><line x1="50" y1="82" x2="55" y2="60"/><line x1="50" y1="40" x2="60" y2="72"/>`),
  },
  {
    id: 'hip-flexor-lunge', name: 'Kneeling Hip Flexor Lunge', part: 'Hips',
    contexts: ['postworkout', 'morning'], difficulty: 'intermediate',
    duration: 30, sides: true,
    ...
    img: svg(`${GROUND}<circle cx="35" cy="45" r="8"/><line x1="35" y1="53" x2="40" y2="72"/><line x1="40" y1="72" x2="60" y2="70"/><line x1="60" y1="70" x2="65" y2="92"/><line x1="40" y1="72" x2="30" y2="90"/><line x1="30" y1="90" x2="45" y2="90"/>`),
  },
  {
    ...
    img: svg(`<line x1="10" y1="80" x2="90" y2="80" class="ground"/><circle cx="18" cy="70" r="8"/><line x1="26" y1="70" x2="55" y2="72"/><line x1="55" y1="72" x2="55" y2="45"/><line x1="55" y1="60" x2="75" y2="55"/>`),
  },
  {
    ...
    img: svg(`<line x1="10" y1="90" x2="90" y2="90" class="ground"/><circle cx="30" cy="55" r="8"/><path d="M35 58 Q50 62 60 60" fill="none"/><line x1="60" y1="60" x2="82" y2="80"/><line x1="35" y1="65" x2="25" y2="85"/><line x1="25" y1="85" x2="45" y2="85"/>`),
  },
  {
    id: 'butterfly', name: 'Butterfly Stretch', part: 'Hips / Inner Thigh',
    contexts: ['bedtime', 'postworkout'], difficulty: 'beginner',
    duration: 45,
    ...
    img: svg(`<circle cx="50" cy="35" r="9"/><line x1="50" y1="44" x2="50" y2="65"/><path d="M50 65 Q30 68 30 82" fill="none"/><path d="M50 65 Q70 68 70 82" fill="none"/><line x1="30" y1="82" x2="70" y2="82"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="42" cy="24" r="8"/><line x1="42" y1="32" x2="42" y2="60"/><line x1="42" y1="60" x2="65" y2="92"/><line x1="42" y1="60" x2="30" y2="92"/><line x1="42" y1="36" x2="70" y2="30"/>`),
  },
  {
    ...
    img: svg(`${GROUND}<circle cx="70" cy="50" r="8"/><path d="M64 55 Q45 40 30 70" fill="none"/><line x1="64" y1="55" x2="82" y2="88"/><line x1="30" y1="70" x2="18" y2="88"/>`),
  },
  {
    id: 'knee-to-chest', name: 'Knee-to-Chest Stretch', part: 'Lower Back / Hips',
    ...
    img: svg(`<line x1="10" y1="80" x2="90" y2="80" class="ground"/><circle cx="18" cy="70" r="8"/><line x1="26" y1="70" x2="50" y2="72"/><line x1="50" y1="72" x2="45" y2="45"/><line x1="26" y1="66" x2="45" y2="48"/><line x1="50" y1="72" x2="78" y2="78"/>`),
  },
];
